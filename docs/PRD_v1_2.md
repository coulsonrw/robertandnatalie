...
**Version:** 1.2  
**Prepared / reissued:** 22 September 2026  
**Status:** Reissued implementation brief; open product decisions still require approval  
**Product owners:** Robert and Natalie  
**Supersedes:** PRD v1.1 (21 September 2026) and v1.0; retain earlier versions for reference only  
**Wedding:** Saturday, 19 December 2026 · Point Clear, Alabama

The approved ivory, gold, original-color crest, and charcoal invitation is the visual foundation. This specification translates the website research into prioritized, testable requirements for design, development, and guest operations. Version 1.1 made design-foundation selection a mandatory pre-build stage. Version 1.2 adds three owner-requested modules: a separate gallery for guest photo uploads and post-wedding pictures, a charity donation in lieu of gifts, and step-by-step directions from Saint Francis Chapel to The Grand Hotel covering passenger drop-off, parking and the way to the reception room. No wedding arrangement, charity, route or photograph is established by this reissue; each is an owner or coordinator input.
...
**Current issue:** v1.2, 22 September 2026. This is the complete reissued PRD, not an addendum. It supersedes v1.1 for implementation. All 63 requirement IDs and 22 acceptance cases of v1.1 are retained unchanged in number and meaning; v1.2 adds eight requirements (CONTENT-07, CONTENT-08, GALLERY-01–05, ARCH-07) and three acceptance cases (AT-23–25). Total: **71 identified requirements and 25 acceptance cases**.

| Change in v1.2 (owner instruction of 22 September 2026) | Operational effect |
|---|---|
| Separate gallery for guest photo uploads and post-wedding pictures (Section 07, GALLERY-01–05; Section 11, ARCH-07) | Moves the gallery and guest uploads from P2 to P1. Uploads need the authenticated guest service, moderation, consent, metadata stripping, owner-controlled storage and a retention decision; nothing is public until approved. |
| Charity donation in lieu of gifts (CONTENT-07) | A short approved note linking to the charity's own donation page. The website never takes payments; the charity, wording and link are owner inputs, verified before publication. |
| Directions from the chapel to The Grand Hotel: passenger drop-off, parking and the way to the reception room (CONTENT-08) | Coordinator- and hotel-verified route with three map destinations, shown on the reception card, the FAQ and the calendar entry. Nothing is published until confirmed; no shuttle or timing is inferred. |
| Acceptance cases AT-23–25 and three decision rows in Section 16 | Gallery, gifts and directions are testable and gated like every other content block (CONTENT-06). |

**v1.1 changes (retained for history)**
...
**Unchanged:** wedding date, named venues and start times, exact invitation copy, original-color Coulson crest, ivory/gold/charcoal identity, household RSVP requirements and privacy decision status. The only scope-boundary change in v1.2 is the promotion of the gallery and guest uploads from P2 to P1. No new wedding arrangements, template purchase, or production authorization are implied.
...
Sections 06–17 correspond to Sections 05–16 in v1.0; v1.2 keeps the v1.1 section numbering. Existing requirement and test identifiers are stable; refer to those identifiers when linking implementation tasks. Dates, estimates, candidate findings, and approvals must remain distinguishable from verified event information.
...
**P1 — optional after P0 acceptance:** approved Our Story content; a separate gallery for approved post-wedding pictures and moderated guest uploads (GALLERY-01–05, ARCH-07); a charity-donation note in lieu of gifts (CONTENT-07); a restrained invitation-opening animation; approved local recommendations; owner-triggered reminder sending. These enhancements must not postpone the core release. The Our Story, Gallery and Gifts navigation items are omitted until their content is approved.

**P2 — explicitly deferred:** guestbook, multilingual content, live-streaming, registry integrations, and seating-plan tools. Reconsider only through a separately approved scope change. (The post-wedding gallery and guest uploads moved to P1 in v1.2 by owner instruction.)

**Out of scope:** native apps, public guest directories, advertising, payment collection (the charity note links to the charity's own donation page; the website never takes or records payments), automated itinerary planning, an AI concierge, social-login requirements, a full wedding-planning platform, and a bespoke general-purpose CMS. Do not invent a registry, charity, dress code, children policy, welcome event, brunch, shuttle, or hotel discount.
...
| `#gifts` | Optional approved note that no gifts are expected and a link to the chosen charity's own donation page; remove the link and section when unpublished (CONTENT-07). |
| `/gallery` | Separate page with two areas: pictures published by the couple and pictures shared by guests. Guest uploads require invitation access; the page and its navigation item are absent until approved pictures exist or uploads are open (GALLERY-01–05). |
...
**Wedding-day guest:** return to the site → reach ceremony or reception directions in one navigation action → view the latest approved logistics and contact instructions, including the chapel-to-reception route with drop-off, parking and the way to the room (CONTENT-08).

**Guest after the wedding:** open the gallery → view the pictures the couple has published → with invitation access, share their own photographs → see them on the site only after the couple approves them (GALLERY-01–05).
...
**CONTENT-07 [P1] Gifts: charity donation in lieu.** Publish an owner-approved note that the couple asks for no gifts and, for guests who wish to give, names one charity (two at most) with its official donation link and an optional sentence on why it matters to the couple. The website links out; it never collects payments, suggests an amount unless the owners approve one, or records who donated. Before publication, verify the charity's official domain and, for a United States charity, its listing in the IRS Tax Exempt Organization Search, and record the check date in the approval register. Present the note as a short "Gifts" card after Travel & Stay and as a "Gifts" question in the FAQs; both are omitted until the wording and link are approved (CONTENT-06). Do not invent a registry or a charity.

**CONTENT-08 [P0] Chapel-to-reception directions.** Publish coordinator-verified, step-by-step directions from Saint Francis Chapel to The Grand Hotel with three confirmed destinations: (a) the passenger drop-off point for the reception (the entrance or porte-cochère by name, and whether valet or attended drop-off is offered); (b) guest parking (self-parking or valet, its location, any charge, and accessible spaces); and (c) the walking route from the drop-off point and from the parking area to the reception room (room name, entrance, accessible route, signage or the hotel staff to ask, and an approximate walking time only when the hotel confirms it). Each destination has its own ordinary map link resolving to the confirmed location; the coordinator confirms whether the resort's One Grand Boulevard address or the hotel's published GPS address is the right destination for each. Show the directions on the reception card, in the "getting between venues" FAQ and in the reception calendar description once approved, from the single content source (DATA-01); keep them printable and readable at 320 pixels. Until the coordinator and the hotel confirm each element, nothing is published and no shuttle, timing or route is inferred (CONTENT-03, CONTENT-06). Wedding-day changes go out through the urgent-logistics banner (OPS-02).

## Gallery (added in v1.2)

**GALLERY-01 [P1] Separate gallery page.** Provide a dedicated `/gallery` route, separate from the single-page flow, with two areas: pictures published by the couple and pictures shared by guests. The navigation item appears only when at least one approved picture is published or guest uploads are open. Use a responsive grid with reserved dimensions, lazy loading below the fold, derivatives within the Section 13 media budgets, visible captions where supplied, and no autoplay carousel, infinite scroll or hover-only information. Alternative text is required for couple-published pictures; guest uploads carry a neutral description ("Photograph shared by a guest") unless a caption is approved. Provide a non-modal way to view each picture; any lightbox follows the dialog rules in NFR-01.

**GALLERY-02 [P1] Guest uploads.** Accept uploads only from an authenticated household session (RSVP-01, SEC-02, SEC-03) between an owner-set opening and closing time; the not-yet-open and closed states are explicit. Validate file type by content (JPEG, PNG and WebP; HEIC converted server-side where the service supports it), enforce configurable per-file size and per-household limits, apply rate limits, strip EXIF and GPS metadata on ingest, and keep originals in owner-controlled private storage (ARCH-06) with derivatives generated by the service. Uploads are never written to the public site directly and never appear before moderation (GALLERY-03). Show progress, failure and retry states with nothing lost on a failed request; do not persist upload content in browser storage or analytics.

**GALLERY-03 [P1] Moderation, consent and takedown.** Every guest upload is private until an owner or coordinator approves it in the administration tools, with reject and remove actions and an audit event recording actor, action and upload identifier but never the picture. Before uploading, the guest confirms in plain language that they may share the picture, that the people in it are content to appear on the couple's website, and that the couple may display and keep it; store that confirmation with the upload. Guests can ask for a picture to be removed through the approved contact route, and removal takes effect at the next publication. Exclude gallery pages and pictures from search engines and social previews, and never apply face recognition, tagging or automatic identification.

**GALLERY-04 [P1] Post-wedding pictures.** Pictures supplied by the couple or their photographer follow the Our Story image pipeline (CONTENT-01, DES-01 rights rules): private originals, metadata-free derivatives, per-picture rights, subject and publication approval, alternative text and optional captions, and the photographer's licence recorded in the asset manifest. Publish them in the post-event phase (OPS-03) once the owners record the gallery's visibility decision under SEC-01 (public or invitation-only). Downloading full-size originals is off unless the owners approve it. No stock or generated imagery.

**GALLERY-05 [P1] Retention and keepsake.** Guest uploads and their consent records are guest data: delete them under the retention rule in SEC-06 unless the owners record a keepsake exception naming what is kept (approved pictures only, without uploader contact details), and update the privacy notice accordingly (SEC-04). Provide the owners an export of approved pictures with captions and a purge routine that also covers derivatives and backups within the SEC-06 window.
...
**ARCH-07 [P1] Uploads and gallery storage.** Static hosting cannot receive uploads. Implement upload, moderation and storage as part of the RSVP service (for the reference implementation: Cloudflare Workers with R2 object storage and D1 records) or through an owner-approved managed gallery provider named in the privacy notice; either way the accounts, storage and exports remain owner-controlled (ARCH-06). Approved pictures may be published as static derivatives by the build for a public gallery, or served by the service with private/no-store policies for an invitation-only gallery (ARCH-04). No upload path accepts a file without a valid household session, and no storage bucket may be publicly listable.
...
All P0 requirements are mandatory. AT-17–22 are pre-build selection gates; retain their pass evidence for release. AT-23–25 cover the v1.2 modules and are required before each module is published. AT-01–16 are the minimum product acceptance suite, supplemented by visual, accessibility, and security testing. All applicable cases must pass before guest release. Use synthetic guest fixtures: one individual, a couple, a named family, an authorized plus-one, and a guest invited to only one event.
...
| AT-23 | Gallery (v1.2). With no approved pictures and uploads closed, `/gallery` and its navigation item are absent. Open uploads with a synthetic household: an unauthenticated upload is refused; an upload over the size or household limit is refused with a clear message; a valid upload has its metadata stripped, stays invisible until approved, appears after approval with a neutral description, and disappears after removal. Search-engine and social-preview metadata exclude gallery pictures; the audit event names no picture content. | GALLERY-01–05; ARCH-07 |
| AT-24 | Gifts (v1.2). Before approval, no gifts card, FAQ or charity link is rendered. After approval, the card and the FAQ show the approved wording, the link opens the charity's official page, no payment form or amount is presented unless approved, and the verification date is recorded in the approval register. | CONTENT-07; CONTENT-06 |
| AT-25 | Chapel-to-reception directions (v1.2). Before coordinator confirmation, no route, drop-off, parking or room instruction is rendered and no shuttle or timing is implied. After confirmation, the reception card, the FAQ and the reception calendar description carry the same three destinations from one source; each map link resolves to the confirmed location; the room name and accessible route are stated; the text is readable and printable at 320 pixels. | CONTENT-08; CONTENT-02/03/05; DATA-01 |
...
| Gallery (v1.2): visibility (public or invitation-only), storage or provider, upload opening and closing dates, per-file and per-household limits, moderation owner, keepsake retention of approved uploads, photographer licence for post-wedding pictures | Robert / Natalie; coordinator for moderation | Before uploads open; before post-wedding publication |
| Charity in lieu of gifts (v1.2): whether to publish, charity name(s), official donation link, approved wording and any suggested amount | Robert / Natalie | Gifts publication |
| Chapel-to-reception route (v1.2): passenger drop-off point, guest parking and charges, walking route and reception room name, accessible route, map destination address, and any shuttle | Coordinator / The Grand Hotel | Directions and guest launch |
