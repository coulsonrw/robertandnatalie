...
| AT-17 | Six to eight credible candidates screened; three alternatives incl. custom benchmark | **In progress** | `docs/selection/CANDIDATE_REGISTER.md` | Owner review |
| AT-18 | Source, rights and build evidence recorded; clean build reproduced; gates pass | **Custom benchmark pass** | Zero-dependency `npm run build`; OFL licences in `docs/licenses/` | Register rows for external candidates |
| AT-19 | Weighted scorecard and effort comparison recompute; weights total 100%; no renormalisation | **In progress** | `docs/selection/SCORECARD.md`, `KEEP_ADAPT_REPLACE.md` | Independent recount |
| AT-20 | Three comparable branded proofs at 320/390/768/1440; original assets and exact copy; synthetic data | **In progress** | `docs/proofs/` (custom), `docs/selection/proofs/alt-*/` (labelled concept mockups) | Owner review |
