...
Generated 2026-09-21T23:16:30.182Z by `node scripts/audit.mjs`. Chromium 141.0.7390.37 (headless) via Playwright 1.56.1, axe-core 4.10.2 (MPL-2.0, vendored at scripts/vendor/axe.min.js), Node v22.22.2.

Build audited: dist/ written 2026-09-21T23:16:19.398Z, repository HEAD c5ba819 with 7 uncommitted source file(s) (the build under test is the working tree, not the commit). File hashes (sha256, first 12): index.html da4762042035, celebration.html 5cf9ea74df2a, rsvp.html 0454479d26eb, privacy.html 73d0fba2ca8d, 404.html 566bcbdf7ef3, js/site.js 06234b4ebea2, js/rsvp.js 69f27c2269d4, styles/site.css 17c208e0fb0e.
...
|---|---|---|---|---|
| `color-contrast` | serious | 113 | home-sealed@390, home-open@390, home-entered@390, home-dialog@390, celebration@390, rsvp-details@390, home-sealed@1440, home-open@1440, home-entered@1440, home-dialog@1440, celebration@1440, rsvp-details@1440 | https://dequeuniversity.com/rules/axe/4.10/color-contrast?application=axeAPI |
...
- `color-contrast` — elements: `.seal-monogram`, `#entry-hint`, `.entry-glance > span:nth-child(1)`, `.entry-glance > .dot[aria-hidden="true"]`, `#invitation-title > .name:nth-child(1)`, `#invitation-title > .conj`, `#invitation-title > .name:nth-child(3)`, `.request`, `.date`, `.venue-script:nth-child(5)`, `.formal:nth-child(6)`, `.venue-script:nth-child(7)`, `.formal:nth-child(8)`, `.closing`, `.glance-line > .dot[aria-hidden="true"]`, `.glance-times > .dot[aria-hidden="true"]:nth-child(2)`, `.dot[aria-hidden="true"]:nth-child(4)`, `article[aria-labelledby="ev-ceremony-title"] > .card-links > .dot[aria-hidden="true"]`, `article[aria-labelledby="ev-reception-title"] > .card-links > .dot[aria-hidden="true"]`, `.keepsake-caption`, `#notes`, `.entry-glance > span:nth-child(3)`. axe reason(s): Element's background color could not be determined due to a background gradient / Element's background color could not be determined because it is overlapped by another element / Element content is too short to determine if it is actual text content / Element's background color could not be determined due to a background image / Element's background color could not be determined because it's partially obscured by another element.
